...
const props = defineProps({
  formData: {
    type: Object as PropType<IExperienceForm>,
    required: true
  }
});
</script>
...
<template>
  <q-form class="experienceForm">
    <q-input v-model="props.formData.title" autofocus class="span2" label="Position" outlined/>
    ...
    <q-input
      v-model="props.formData.end_date"
      :disable="props.formData.is_ongoing"
      label="End Date"
      outlined
      type="date"
    />
